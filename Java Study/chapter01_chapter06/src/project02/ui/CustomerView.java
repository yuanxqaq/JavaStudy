...
public class CustomerView {
    ...
    public CustomerView(){
        Customer customer = new Customer("王涛",'男',23,"12389231209","123@gmail.com");
    ...
    private void modifyCustomer(){
        ...
        boolean idRepalaced = customerList.replaceCustomer(number-1,newCust);
